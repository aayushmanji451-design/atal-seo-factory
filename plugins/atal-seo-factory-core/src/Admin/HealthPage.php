...
final class HealthPage {
	...
	private const PAGE_SLUG = 'atal-seo-factory-core-health';

	private const RUN_ACTION = 'atal_seo_factory_task_02_acceptance';

	private const DOWNLOAD_ACTION = 'atal_seo_factory_task_02_acceptance_download';
